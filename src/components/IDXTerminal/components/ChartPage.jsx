...
//
// FIX: import CandleChart path diperbaiki dari
//   "../chart/CandleChart" → "../../chart/CandleChart"
//   (components/ ada di dalam IDXTerminal/, jadi naik 2 level ke src/components/)
      ...
      <div className="chart-header">
        ...
        <button
          ...
          style={{
            ...
            fontSize:   12,
            marginLeft: 6,
            border:     `1px solid ${inWatchlist ? "#f59e0b" : "#0f2040"}`,
            borderRadius: 3,
            background: inWatchlist ? "rgba(245,158,11,0.15)" : "transparent",
            color:      inWatchlist ? "#f59e0b" : "#4a6080",
            cursor:     "pointer",
          }}
        >
          {inWatchlist ? "★" : "☆"}
      ...
      <div className="chart-box">
        ...
        <div className="indicator-row">
          <div className="ind-pill">
            MA20 <span style={{ color: "#f59e0b" }}>
              {indicators.ma20 ? fmtPrice(indicators.ma20) : "—"}
            </span>
          </div>
          <div className="ind-pill">
            MA50 <span style={{ color: "#3b82f6" }}>
              {indicators.ma50 ? fmtPrice(indicators.ma50) : "—"}
            </span>
          </div>
          <div className="ind-pill">
            RSI <span style={{ color: "#a78bfa" }}>
              {indicators.rsi ? indicators.rsi.toFixed(1) : "—"}
            </span>
          </div>
          <div className="ind-pill">
            MACD{" "}
            <span className={indicators.macd >= 0 ? "up" : "dn"}>
