...
export default function PortfolioPage({ selectedTicker, onSelectTicker }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      <div style={{ display: "flex", gap: 2, padding: "8px 12px 0", borderBottom: "1px solid #0f2040", flexShrink: 0 }}>
        {[
          ...
          <div>
            ...
            <div style={{ background: "#070d1c", border: "1px solid #0f2040", borderRadius: 6, padding: 10 }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 10 }}>
                ...
                <tbody>
                  {holdings.map((h) => (
                    <tr key={h.ticker} style={{ borderBottom: "1px solid #0a1830", cursor: "pointer" }} onClick={() => onSelectTicker(h.ticker)}>
                  ...
                  {!holdings.length && (
                    <tr><td colSpan={7} style={{ padding: "32px 8px", textAlign: "center", color: "#4a6080" }}>Belum ada holdings</td></tr>
                  )}
                </tbody>
              </table>
            </div>
